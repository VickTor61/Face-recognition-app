...
const Register = ({ onRouteChange }) => {
  return (
    <Form
      className="text-primary bg-light p-4 shadow-lg rounded py-4"
    ...
    >
      ...
      <Button type="submit" className="mx-3" variant="outline-primary" onClick={() => onRouteChange("home")}>Register</Button>
